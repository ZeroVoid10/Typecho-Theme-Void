...
?>
    ...
    <!-- <script><?php print_r($this); ?></script> -->
            ...
            <div class="navbar bg-black">
                ...
                <ul class="nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu login-panel wrapper animated fade-in bg-white-s font-gray" aria-labelledby="loginMenu">
                            <form action="<?php $this->options->loginAction(); ?>" method="post" role="form" name="login">
                                ...
                                <button class="h-w padder-lg btn-rounded login-btn" type="submit">
                                    <span>登入</span>
                                </button>
